                ...
                <div class="mt-5 w-75">
                    <form id="signupForm" method="POST" action="submit.php">
                        ...
                        <div class="input-group mb-3">
                            <input style="outline: none;" id="password" name="password" class="signup-input" type="password" placeholder="Password" required>
                            <button type="button" class="btn btn-outline-secondary" id="togglePassword">Show</button>
                        </div>
                        <div class="input-group mb-3">
                            <input style="outline: none;" id="confirmPassword" name="confirmPassword" class="col-8 signup-input" type="password" placeholder="Confirm Password" required>
                            <button type="button" class="btn btn-outline-secondary col-4" id="toggleConfirmPassword">Show</button>
                        </div>
