    ...
    <!-- MM Timeline Tugas -->
     <div class="container timeLineLink-content content hidden">
       <?php
        ...
        $tugas = [
            ['judul' => 'Tugas 1', 'deskripsi' => 'Deskripsi tugas 1', 'tanggal_deadline' => '2024-07-10'],
            ['judul' => 'Tugas 2', 'deskripsi' => 'Deskripsi tugas 2', 'tanggal_deadline' => '2024-07-15'],
            ['judul' => 'Tugas 3', 'deskripsi' => 'Deskripsi tugas 3', 'tanggal_deadline' => '2024-07-20'],
        ];

        $colors = ['#71A430', '#5BC0EB', '#FDE74C']; // Warna untuk setiap tugas
