            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-5">
                    <h5 style="color: gray;" class="fw-bold d-flex gap-4">
                        Cloud Computing
                        <div>
                            <button><img src="<?=base_url("assets/images/pencil.svg ") ?>" style="background-color: ;" alt=""></button>
                            <button><img src="<?=base_url("assets/images/sampah.svg ") ?>" style="background-color: ;" alt=""></button>
                        </div>
                    </h5>
