                ...
                <div class="mt-5 w-75">
                    <form id="signupForm" method="POST" action="submit.php">
                        ...
                        <div class="input-group mb-3">
                            <input style="outline: none;" id="password" name="password" class="signup-input w-100" type="password" placeholder="Password" required>
                            <button type="button" class="btn btn-outline-secondary" id="togglePassword">Show</button>
                        </div>
                        <div class="input-group mb-3 fle">
                            <input style="outline: none;" id="confirmPassword" name="confirmPassword" class="signup-input w-100" type="password" placeholder="Confirm Password" required>
