            ...
            <div class="col-12 col-md-6 d-flex flex-column align-items-center text-center mb-4 mb-md-0">
                ...
                <div class="mt-5 w-75">
                    <form id="signupForm" method="POST" action="submit.php">
                        ...
                        <input style="outline: none;" id="confirmPassword" name="confirmPassword" class="signup-input w-100 mb-3" type="password" placeholder="Confirm Password" required>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        confirmPasswordInput.addEventListener('input', function() {
            if (confirmPasswordInput.value !== passwordInput.value) {
                confirmPasswordInput.classList.add('border-3', 'border-danger');
                passwordMismatchError.textContent = 'Password and Confirm Password do not match';
            } else {
                confirmPasswordInput.classList.remove('border-3', 'border-danger');
        ...
        form.addEventListener('submit', function(event) {
            if (confirmPasswordInput.value !== passwordInput.value) {
                ...
                confirmPasswordInput.classList.add('border-2', 'border-danger');
                passwordMismatchError.textContent = 'Password and Confirm Password do not match';
            }
        });
    });
