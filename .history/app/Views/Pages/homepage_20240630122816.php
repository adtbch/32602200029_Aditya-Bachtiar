...
<div class="bg-second rounded-4 border p-2">
    <div class="row p-2">
        ...
        <div class="justify-content-end d-flex gap-4">
            <button class="bg-second text-primary fw-semibold rounded-circle p-2">Reset</button>
            <button class="bg-primary text-white fw-semibold rounded-circle p-2">Add</button>
        </div>
    </div>
</div>
