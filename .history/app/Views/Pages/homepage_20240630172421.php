...
PHP adalah bahasa skrip sisi server gratis open-source yang banyak digunakan dalam web development. PHP tersedia di semua OS utama, seperti Linux, Windows dan MacOS.</td>
        ...
        ?>
                    ...
                    <td>
                    <button class="col-6" style="background-color: transparent; border: none;"><img class="" style="height: 3vh;" src="<?=base_url("assets/images/pencil.svg ") ?>" alt=""></button>
                    <button class="col-6" style="background-color: transparent; border: none;"><img class="" style="height: 3vh;" src="<?=base_url("assets/images/sampah.svg ") ?>" alt=""></button>
                </td>
                </tr>
        </tbody>
    </table>
