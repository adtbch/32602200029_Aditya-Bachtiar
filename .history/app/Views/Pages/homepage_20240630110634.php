...
<!-- MM Mata Kuliah -->
 ...
 <!-- detail Mata Kuliah -->
  <div class="detailMataKuliahLink-content content hidden container">
        <h3 class="col-6 col-sm-5 col-md-3 text-primary fw-bold position-relative text-decoration-underline">MataKuliah>CloudC <span style="background-color: #71A430;"></span></h3>
  </div>
<!-- MM jadwal Kuliah -->
