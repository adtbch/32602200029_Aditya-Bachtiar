            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-5">
                    <h5 style="color: gray;" class="fw-bold d-flex gap-4">
                        Cloud Computing
                        <div>
                            <button style="background-color: transparent; border: n;"><img src="<?=base_url("assets/images/pencil.svg ") ?>" alt=""></button>
                            <button style="background-color: transparent; border: n;"><img src="<?=base_url("assets/images/sampah.svg ") ?>" alt=""></button>
                        </div>
                    </h5>
