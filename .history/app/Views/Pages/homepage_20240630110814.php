...
<!-- MM Mata Kuliah -->
 ...
 <!-- detail Mata Kuliah -->
  <div class="detailMataKuliahLink-content content hidden container">
        <h3 class=" col-sm-5 text-primary fw-bold position-relative text-decoration-underline">MataKuliah>Cloud Computing <span style="background-color: #71A430;"></span></h3>
  </div>
<!-- MM jadwal Kuliah -->
