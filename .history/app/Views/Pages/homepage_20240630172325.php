...
PHP adalah bahasa skrip sisi server gratis open-source yang banyak digunakan dalam web development. PHP tersedia di semua OS utama, seperti Linux, Windows dan MacOS.</td>
        ...
        ?>
                    ...
                    <td>
                    <button style="background-color: transparent; border: none;"><img style="height: 2vh;" src="<?=base_url("assets/images/pencil.svg ") ?>" alt=""></button>
                    <button style="background-color: transparent; border: none;"><img style="height: 2vh;" src="<?=base_url("assets/images/sampah.svg ") ?>" alt=""></button>
                </td>
                </tr>
        </tbody>
    </table>
