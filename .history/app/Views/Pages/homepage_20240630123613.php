...
<!-- MM Mata Kuliah -->
 ...
 <!-- detail Mata Kuliah -->
  <div class="detailMataKuliahLink-content content hidden container">
        <h3 class="text-primary fw-bold position-relative text-decoration-underline"><a href=""></a> MataKuliah>Cloud Computing <span style="background-color: #71A430;"></span></h3>
