...
<div class="bg-second rounded-4 border p-2">
    <div class="row p-2">
        ...
        <div class="justify-content-end d-flex gap-4">
            <button class="bg-second text-primary fw-semibold rounded-4 px-4 py-1">Reset</button>
            <button class="bg-primary text-white fw-semibold rounded-4 p-1">Add</button>
        </div>
    </div>
</div>
