                ...
                <?php foreach ($tugas as $index => $item): ?>
                    <div class="task-item" style="border-left: 5px solid <?= $colors[$index] ?>;">
                        <h4 class="d-flex justify-content-between"><?= htmlspecialchars($item['judul']) ?>
                          <div>
                            <button style="height: 2vh; background-color: transparent; border: none;"><img src="<?=base_url("assets/images/pencil.svg ") ?>" alt=""></button>
                            <button style="height: 2vh; background-color: transparent; border: none;"><img src="<?=base_url("assets/images/sampah.svg ") ?>" alt=""></button>
                        </div>
                        </h4>
