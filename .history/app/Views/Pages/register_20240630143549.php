            ...
            <div class="col-12 col-md-6 d-flex flex-column align-items-center text-center mb-4 mb-md-0">
                ...
                <div class="mt-5 w-75">
                    <form id="signupForm" method="POST" action="submit.php">
                        ...
                        <input id="password" name="password" class="signup-input w-100 mb-3" type="password" placeholder="Password" required>
                        <input id="confirmPassword" name="confirmPassword" class="signup-input w-100 mb-3" type="password" placeholder="Confirm Password" required>
                        <div id="passwordMismatch" class="error-message"></div>
                        <button type="submit" class="signup-button text-white fw-bold w-100 p-2 mb-3" style="outline: none;">Create Account</button>
                    </form>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        confirmPasswordInput.addEventListener('input', function() {
            if (confirmPasswordInput.value !== passwordInput.value) {
                confirmPasswordInput.classList.add('border', 'border-danger');
                passwordMismatchError.textContent = 'Password and Confirm Password do not match';
            } else {
                confirmPasswordInput.classList.remove('border', 'border-danger');
