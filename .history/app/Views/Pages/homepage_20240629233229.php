...
<!-- MM jawal Ujian -->
 ...
 <!-- MM jadwal Belajar -->
<div class="belajar-content hidden">
    <!--  -->
    <div class="container">
...
<!-- MM Mata Kuliah -->
 <div class="mk-content hidden row container">
    <div class="col-7 gap-2 d-flex align-items-center">
        <div class="col-6">
            <img src="<?=base_url("assets/images/kelas.svg")?>" class="img-fluid">
        </div>
        <div class="col-4">
           <h5 style="color: gray;" class="fw-bold">Nama Mata Kuliah
            d
            <img src="<?=base_url("assets/images/editing.svg")?>" alt="">
            <img src="<?=base_url("assets/images/hapus.svg")?>" alt="">
           </h5>
           <div>semester</div>
        </div>
    </div>
    <a href="#">
        <h4 class="my-4 text-third position-relative fst-italic">+ New<span>mk</span></h4>
    </a>
 </div>
<!-- MM jadwal Kuliah -->
 ...
 <!-- input jk -->
  <div class="inputjk-content container hidden">
  ...
  <!-- inputJu -->
  <div class="inputju-content container hidden">
