        ...
        <div class="col-4">
            <div class="rounded bg-second p-4" style="border: 2px solid #71A430;">
                <div class="d-flex row gap-4 justify-content-center"> 
                    <img src="<?=base_url("assets/images/DSC_0357.jpg") ?>" style="object-position: center; object-fit: contain; width: 15vh; height: 15vh;" class="bg-white col-2 rounded-circle" alt="">
