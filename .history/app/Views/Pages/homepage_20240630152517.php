...
<div class="createTugas-content content hidden container ">
    ...
    <div class="container-fluid mt-5">
        <div class="row">
        <h3 class="my-4 col-6 col-sm-5 col-md-3 text-primary fw-bold position-relative text-decoration-underline">TimeLine Tugas<span style="background-color: #71A430;"></span></h3>
