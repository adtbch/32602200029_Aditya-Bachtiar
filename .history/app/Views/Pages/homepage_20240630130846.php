...
<!-- MM tugas -->
 <div class="tugasLink-content content container hidden">
    <div class="col-12 bg-second border-2 border-black rounded-4 p-4" style="align-items: start; justify-content:space-between;">
                <div class="d-flex w-100 justify-content-between">
            ...
            foreach ($files as $file) {
                if ($file !== '.' && $file !== '..' && pathinfo($file, PATHINFO_EXTENSION) === 'pdf') {
                    ...
                    <div class=" d-flex align-items-center">
                        <a href="<?= $file_path ?>" download id="t" style="background-color: transparent;">
                        <div class="d-flex align-items-end">
