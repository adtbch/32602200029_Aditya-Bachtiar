...
<!-- MM Mata Kuliah -->
 ...
 <!-- detail Mata Kuliah -->
  <div class="detailMataKuliahLink-content content hidden container">
        <h3 class="text-primary fw-bold position-relative text-decoration-underline">MataKuliah>Cloud Computing <span style="background-color: #71A430;"></span></h3>
        <h3 class="my-4 text-primary fw-bold position-relative">Materi</h3>
<div class="bg-second rounded-4 border p-2">
        ...
        <?php
            ...
            foreach ($files as $file) {
                if ($file !== '.' && $file !== '..' && pathinfo($file, PATHINFO_EXTENSION) === 'pdf') {
                    ...
                    ?>
                    <div class="col-12 d-flex align-items-center mb-2 justify-content-between p-2">
                        <div class="d-flex align-items-end">
                            <img src="<?=base_url("assets/images/file.svg")?>" alt="">
                            <span class="me-2 text-primary fw-semibold"><?= htmlspecialchars($file) ?></span>
                        </div>
                        <a href="<?= $file_path ?>" download><img src="<?=base_url("assets/images/unduh.svg")?>" alt=""></a>
                        <span style="color: #71A430;" class="undeerline"></span>
                    </div>
                    <?php
                }
            }
