    ...
    <div class="d-flex row justify-content-center">
        <div class="col-6 col-sm-5 col-md-6">
            ...
            <div>
                ...
                <textarea class="col-12 rounded p-2 bg-second" type="text" >
            </div>
            <div>
                <h5 class="my-3 text-primary fw-bold position-relative">Hari Ujian</h5>
                <input class="col-12 rounded p-2 bg-second" type="text" >
            </div>
            <div>
                <h5 class="my-3 text-primary fw-bold position-relative">Ruang Ujian</h5>
                <input class="col-12 rounded p-2 bg-second" type="text" >
            </div>
