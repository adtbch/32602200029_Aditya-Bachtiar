...
<!-- MM tugas -->
 <div class="tugasLink-content content container hidden">
    <div class="col-12 bg-second rounded-4 p-4" style="align-items: start; justify-content:space-between; height: 25vh;">
                <div class="d-flex w-100 justify-content-between">
                ...
                <div class="d-flex gap-4 fw-semibold text-primary">
                    <p>26/06/2024</p>
                    <p>23:29</p>
                </div>
                <div>
            ...
            foreach ($files as $file) {
                if ($file !== '.' && $file !== '..' && pathinfo($file, PATHINFO_EXTENSION) === 'pdf') {
                    $file_path = base_url("assets/materi/{$file}");
                    ?>
                    <div class=" d-flex align-items-center mb-2 justify-content-between p-2 border-bottom border-3 border-dark-emphasis">
                        <a href="<?= $file_path ?>" download id="detailMataKuliahLink" style="background-color: transparent;">
                        <div class="d-flex align-items-end">
                            <img src="<?=base_url("assets/images/file.svg")?>" alt="">
                            <span class="me-2 text-primary fw-semibold"><?= htmlspecialchars($file) ?></span>
