 ...
 <div class="mk-content hidden row container">
    <div class="col-10">
        <div class="row d-flex align-items-center">
            ...
            <div class="col-5">
                <h5 style="color: gray;" class="fw-bold d-flex gap-4">Nama Mata Kuliah
                    <div>
                        <button><img src="<?=base_url("assets/images/pencil.svg ") ?>" alt=""></button>
                        <button><img src="<?=base_url("assets/images/sampah.svg ") ?>" alt=""></button>
                    </div>
    ...
    <a href="#">
        <h4 class="my-4 text-third position-relative fst-italic">+ New<span class="hidden">mk</span></h4>
    </a>
 </div>
<!-- MM jadwal Kuliah -->
 <div class="jadwalKuliah-content hidden">
    <div class="container row">
        <div style="border-color: #71A430;" class="col-12 col-md-7 bg-white border shadow rounded p-4">
            <div class=" d-flex justify-content-between">
                <h5 class="fw-bold text-primary">Senin</h5>
                <div>
                    <button><img src="<?=base_url("assets/images/pencil.svg ") ?>" alt=""></button>
