...
<div class="managementLink-content content hidden">
    ...
    <div class="container row d-flex justify-content-center">
        ...
        <div class="col-4 p-2">
            <a href="#" class="d-flex align-items-end align-text-bottom gap-2 text-decoration-none" id="mataKulihLink">
                <div class="bg-primary rounded-4 shadow">
...
<!-- MM jadwal Kuliah -->
 ...
 <!-- input jk -->
  <div class="jadwalKuliahLink-content content hidden container">
