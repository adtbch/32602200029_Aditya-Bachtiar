...
<div class="createTugas-content content hidden container ">
    ...
    <div class="d-flex row justify-content-center">
        <div class="col-6 col-sm-5 col-md-6">
            <div>
                <h4 class="my-2 text-primary fw-bold position-relative">Nama Tugas</h4>
                <input class="col-12 rounded p-2 bg-second" type="text" placeholder="mata kuliah">
            </div>
            <div>
                <h4 class="my-2 text-primary fw-bold position-relative">Deskripsi Tugas</h4>
                <input class="col-12 rounded p-2 bg-second" type="long" placeholder="waktu">
            </div>
            <div>
