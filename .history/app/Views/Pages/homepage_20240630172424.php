...
<div class="managementLink-content content hidden">
    ...
    <div class="container row d-flex justify-content-center">
        ...
        <div class="col-4 p-2">
            <a href="#" class="d-flex align-items-end align-text-bottom gap-2 text-decoration-none" id="todoListMMLink">
                <div class="bg-primary rounded-4 shadow">
    ...
    <div class="col-10">
        <a href="#" id="detailMataKuliahLink">
            <div class="d-flex align-items-center gap-2">
                <div class="col-8">
                    <img src="<?=base_url("assets/images/kelas.svg")?>" >
                </div>
                <div class="col-4">
                    <div class="fw-bold d-flex gap-4">
                        <h5 style="color: gray;">Cloud Computing</h5>
                        <div class="col-3">
                            <a href="#" id="catatanLink" style="background-color: transparent; border: none;"><img src="<?=base_url("assets/images/pencil.svg ") ?>" alt=""></a>
...
PHP adalah bahasa skrip sisi server gratis open-source yang banyak digunakan dalam web development. PHP tersedia di semua OS utama, seperti Linux, Windows dan MacOS.</td>
        ...
        ?>
                    ...
                    <td>
                    <button class="col-6" style="background-color: transparent; border: none;"><img class="img-fluid" style="height: 3vh;" src="<?=base_url("assets/images/pencil.svg ") ?>" alt=""></button>
                    <button class="col-6" style="background-color: transparent; border: none;"><img class="img-fluid" style="height: 3vh;" src="<?=base_url("assets/images/sampah.svg ") ?>" alt=""></button>
                </td>
                </tr>
        </tbody>
    </table>
