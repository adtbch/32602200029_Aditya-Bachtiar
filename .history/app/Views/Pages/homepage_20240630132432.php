    ...
    <div class="d-flex row justify-content-center">
        <div class="col-6 col-sm-5 col-md-6">
            ...
            <div class="mt-5 d-flex gap-3">
                <button class="col-4 bg-second border-2 border-primary class="col-12 rounded p-2 bg-second" rounded p-1 text-white">
                    Reset
                </button>
                <button class="col-4 bg-primary rounded p-1 text-white">
                    Add
                </button>
            </div>
        </div>
