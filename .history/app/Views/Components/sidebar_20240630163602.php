...
<body>
    <div class="fluid-container">
        ...
        <textarea id="messageText" style="height: 50vh; width: 100%;"></textarea>
        <div class="d-flex justify-content-center">
            <a href="#" id="contactUsLink" class="hidden">
                <button class="p-2 rounded-2 bg-primary text-white fw-semibold mt-4" id="sendMessageBtn">Send Message</button>
            </a>
        </div>
    </div>
