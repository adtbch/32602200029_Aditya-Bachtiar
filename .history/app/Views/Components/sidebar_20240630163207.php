        ...
        <div class="row row-cols-2 m-0">
            ...
            <div class="col-9 p-3">
                ...
                <div id="mainContent">
                    ...
                    <h4 class="mb-4 fw-bold text-primary">Message</h4>   
                        <div type="text" style="height: 50vh; width: 100%; border: 2px solid gray;"  class="p-5 bg-white rounded-2 d-flex justify-content-center">
                            <div class="col-4 bg-second rounded-4 shadow row d-flex justify-content-center text-center p-2" style="border: 2px solid #71A430;">
