        ...
        <div class="row row-cols-2 m-0">
            ...
            <div class="col-9 p-3">
                    ...
                    <nav class="bg-primary navbar navbar-custom w-100 rounded-4">
                        <div class="container-fluid">
                            ...
                            <ul class="navbar-nav ms-auto d-flex flex-row gap-3">
                                <!-- About Us -->
                                <li class="nav-item">
                                    <a style="background-color: transparent;" class="nav-link text-white fs-5 fw-bold fst-italic" href="#" id="aboutUsLink"><div>About Us</div></a>
                                </li>
                                <!-- Contact Us -->
                                <li class="nav-item">
                                    <a style="background-color: transparent;" class="nav-link text-white fs-5 fw-bold fst-italic" href="#" id="contactUsLink"><div>Contact Us</div></a>
                                </li>
                            </ul>
                        </div>
                    </nav>
                ...
                <div id="mainContent">
                    ...
                    <div class="rounded-4 contactUsLink-content content hidden container bg-second" style="border: 2px solid #71A430;">
                       <h1 class="fst-italic fw-bold">What is RemindMe?</h1>
                       <p>RemindMe adalah sebuah aplikasi student planner berbasis web yang bisa
                            membantu mahasiswa memanage akademik dengan baik.
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quod, eaque
