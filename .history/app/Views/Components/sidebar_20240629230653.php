        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (savedLink) {
                links.forEach(link => {
                    ...
                    if (savedLink === 'Belajar') {
                        document.querySelector('.belajar-content').classList.remove('hidden');
                    } else {
                        document.querySelector('.belajar-content').classList.add('hidden');
                    }
                    if (savedLink === 'Mata Kuliah') {
                        document.querySelector('.mk-content').classList.remove('hidden');
                    } else {
                        document.querySelector('.mk-content').classList.add('hidden');
                    }
