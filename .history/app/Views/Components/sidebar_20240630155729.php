                    ...
                    <nav class="bg-primary navbar navbar-custom w-100 rounded-4">
                        <div class="container-fluid">
                            ...
                            <ul class="navbar-nav ms-auto d-flex flex-row gap-3">
                                <!-- About Us -->
                                <li class="nav-item">
                                    <a style="background-color: transparent;" class="nav-link text-white fs-5 fw-bold fst-italic" href="#" id="aboutUsLink"><p></p>About Us</a>
                                </li>
                                <!-- Contact Us -->
                                <li class="nav-item">
                                    <a style="background-color: transparent;" class="nav-link text-white fs-5 fw-bold fst-italic" href="#" id="contactUsLink">Contact Us</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
