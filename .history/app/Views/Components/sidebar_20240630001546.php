    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (savedLinkId) {
            links.forEach(link => {
                if (link.id === savedLinkId) {
                    ...
                    document.querySelector(`.${link.id}-content`).classList.remove('hidden');
                }
            });
        }
        ...
        links.forEach(link => {
            link.addEventListener('click', function () {
                ...
                // Show or hide content based on the clicked link
                document.querySelectorAll('.content').forEach(content => content.classList.add('hidden'));
                document.querySelector(`.${linkId}-content`).classList.remove('hidden');
            });
        });
    });
</script>
