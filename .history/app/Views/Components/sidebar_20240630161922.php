        ...
        <div class="row row-cols-2 m-0">
            ...
            <div class="col-9 p-3">
                ...
                <div id="mainContent">
                    ...
                    <div class="p-5 rounded-4 message-content content hidden container bg-second" style="border: 2px solid #71A430;">
                    <h4 class="mb-4 fw-bold text-primary">Message</h4>   
                        <textarea type="text" style="height: 50vh; width: 100%;" name="" id="">
                            <div>hello</div>
                        </textarea>
                        <div class="d-flex justify-content-center">
                            <a href="" id="messageLink">
