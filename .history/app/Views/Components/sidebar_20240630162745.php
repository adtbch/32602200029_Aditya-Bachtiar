        ...
        <div class="row row-cols-2 m-0">
            ...
            <div class="col-9 p-3">
                ...
                <div id="mainContent">
                    ...
                    <h4 class="mb-4 fw-bold text-primary">Message</h4>   
                        <div type="text" style="height: 50vh; width: 100%; border: 2px solid #71A430;"  class="bg-white rounded-2 d-flex justify-content-center">
                            <div class="col-4 bg-white rounded-4" style="border: 2px solid #71A430;">
