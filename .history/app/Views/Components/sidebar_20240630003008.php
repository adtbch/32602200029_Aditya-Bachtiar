    ...
    <div class="fluid-container">
        <div class="row row-cols-2 m-0">
            ...
            <div class="col-9 p-3">
                ...
                <div id="mainContent">
                    <div class="profileLink-content content hidden">
                        <h1>Profile Content</h1>
                        <p>Ini adalah konten untuk Profile.</p>
                    </div>
                    <div class="homeLink-content content hidden">
                        <h1>Home Content</h1>
                        <p>Ini adalah konten untuk Home.</p>
                    </div>
                    <div class="groupLink-content content hidden">
                        <h1>Group Project Content</h1>
                        <p>Ini adalah konten untuk Group Project.</p>
                    </div>
                    <div class="managementLink-content content hidden">
                        <h1>Management dan Mentoring Content</h1>
                        <p>Ini adalah konten untuk Management dan Mentoring.</p>
                    </div>
                    <div class="calendarLink-content content hidden">
                        <h1>Calendar Content</h1>
                        <p>Ini adalah konten untuk Calendar.</p>
                    </div>
                </div>
