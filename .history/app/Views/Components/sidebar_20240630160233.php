        ...
        <div class="row row-cols-2 m-0">
            ...
            <div class="col-9 p-3">
                ...
                <div id="mainContent">
                    ...
                    <div class="p- rounded-4 contactUsLink-content content hidden container bg-second" style="border: 2px solid #71A430;">
                       <input type="text" style="height: 70vh; width: 100%;" name="" id="">
                    </div>
